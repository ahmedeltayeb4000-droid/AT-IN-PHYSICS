...
const control = "at-control mt-1.5 block w-full rounded-xl border border-border bg-canvas px-3 py-2.5 text-sm text-text outline-none transition placeholder:text-text-subtle focus:border-accent focus:ring-2 focus:ring-accent/20 disabled:cursor-not-allowed disabled:opacity-50";
